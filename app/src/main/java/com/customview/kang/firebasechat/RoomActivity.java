...
public class RoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (RecyclerView) findViewById(R.id.rlistView);
...
class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.Holder>{
    ...
    public class Holder extends RecyclerView.ViewHolder{
        ...
        public Holder(View itemView) {
            ...
            userName = (TextView) itemView.findViewById(R.id.textName);
            msg = (TextView) itemView.findViewById(R.id.textChat);
        }
    }
}